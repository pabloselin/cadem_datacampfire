			...
			if (null != t || null != e || null != i) {
					...
					(A.init = function(t) {
						...
						(A.parseXml = function(e) {
							...
							try {
								...
								return (n = new f.DOMParser()).parseFromString(
									e,
									"text/xml"
								);
							}
						...
						(A.Property.prototype.getFillStyleDefinition = function(
							t,
							e
						) {
							var i = this.getDefinition();
							if (null != i && i.createGradient)
								return i.createGradient(A.ctx, t, e);
						...
						(A.Property.prototype.toPixels = function(t, e) {
							...
							if (i.match(/pt$/))
								return (
									this.numValue() * this.getDPI(t) * (1 / 72)
								);
							...
							if (i.match(/%$/))
								return (
									this.numValue() * A.ViewPort.ComputeSize(t)
								);
							var n = this.numValue();
							return e && n < 1
								? n * A.ViewPort.ComputeSize(t)
								: n;
						}),
					...
					return (
							...
							this.Parse = function(t) {
								for (
									...
									n.fontStyle || -1 == r.Styles.indexOf(i[a])
										? n.fontVariant ||
										  -1 == r.Variants.indexOf(i[a])
											? n.fontWeight ||
											  -1 == r.Weights.indexOf(i[a])
												? n.fontSize
													? "inherit" != i[a] &&
													  (s += i[a])
													: ("inherit" != i[a] &&
						...
						(A.Transform = function(t) {
							...
							(this.Type = {}),
								...
								(this.unapply = function(t) {
									for (
										var e = this.transforms.length - 1;
										0 <= e;
										e--
									)
						...
						(A.AspectRatio = function(
							...
							var u =
									(e = (e = A.compressSpaces(e)).replace(
										/^defer\s/,
										""
									)).split(" ")[0] || "xMidYMid",
								c = e.split(" ")[1] || "meet",
						...
						(A.Element.ElementBase = function(a) {
							...
							if (null != a && 1 == a.nodeType) {
								for (var i = 0; i < a.attributes.length; i++) {
									...
									this.attributes[s] = new A.Property(
										s,
										n.value
									);
								}
								...
								(this.setContext = function(t) {
									...
									if (
										(this.style(
											...
											(t.lineCap = this.style(
												"stroke-linecap"
											).value),
										this.style(
											"stroke-linejoin"
										).hasValue() &&
											(t.lineJoin = this.style(
												"stroke-linejoin"
											).value),
										this.style(
											"stroke-miterlimit"
										).hasValue() &&
											(t.miterLimit = this.style(
												"stroke-miterlimit"
											).value),
										this.style("paint-order").hasValue() &&
											(t.paintOrder = this.style(
												"paint-order"
											).value),
										this.style(
											"stroke-dasharray"
								...
								(this.renderChildren = function(t) {
									this.path(t),
										...
										"" != t.fillStyle &&
											...
											this.style(
												"fill-rule"
											).valueOrDefault("inherit")
												? t.fill(
														this.style("fill-rule")
															.value
												  )
												: t.fill()),
							...
							(this.base = A.Element.RenderedElementBase),
								...
								(this.setContext = function(t) {
									...
									if (
										...
										(e = this.attribute("width").toPixels(
											"x"
										)),
											(i = this.attribute(
												"height"
							...
							(this.base = A.Element.PathElementBase),
								...
								(this.path = function(t) {
									var e = this.attribute("x").toPixels("x"),
										...
										n = this.attribute("width").toPixels(
											"x"
										),
										s = this.attribute("height").toPixels(
											"y"
										),
						...
						(A.Element.polyline = function(t) {
							(this.base = A.Element.PathElementBase),
								this.base(t),
								(this.points = A.CreatePath(
									this.attribute("points").value
								)),
								(this.path = function(t) {
									var e = new A.BoundingBox(
										this.points[0].x,
										this.points[0].y
									);
									null != t &&
									...
									(this.tokens = t.split(" ")),
										(this.reset = function() {
											(this.i = -1),
												...
												(this.start = new A.Point(
													0,
													0
												)),
												(this.control = new A.Point(
													0,
													0
												)),
												(this.current = new A.Point(
													0,
													0
												)),
												(this.points = []),
						...
						(A.Element.pattern = function(t) {
							(this.base = A.Element.ElementBase),
								...
								(this.createPattern = function(t, e) {
									var i = this.attribute("width").toPixels(
											"x",
											!0
										),
										n = this.attribute("height").toPixels(
											"y",
											!0
										),
										s = new A.Element.svg();
									(s.attributes.viewBox = new A.Property(
										"viewBox",
										this.attribute("viewBox").value
									)),
										(s.attributes.width = new A.Property(
											"width",
											i + "px"
										)),
										(s.attributes.height = new A.Property(
											"height",
											n + "px"
										)),
										(s.attributes.transform = new A.Property(
											"transform",
											this.attribute(
												"patternTransform"
											).value
									...
									for (var o = -1; o <= 1; o++)
										for (var l = -1; l <= 1; l++)
											r.save(),
												(s.attributes.x = new A.Property(
													"x",
													o * a.width
												)),
												(s.attributes.y = new A.Property(
													"y",
													l * a.height
												)),
												s.render(r),
								...
								(this.render = function(t, e, i) {
									t.translate(e.x, e.y),
										...
										"strokeWidth" ==
											this.attribute(
												"markerUnits"
											).valueOrDefault("strokeWidth") &&
											t.scale(t.lineWidth, t.lineWidth),
										t.save();
									var n = new A.Element.svg();
									(n.attributes.viewBox = new A.Property(
										"viewBox",
										this.attribute("viewBox").value
									)),
										(n.attributes.refX = new A.Property(
											"refX",
											this.attribute("refX").value
										)),
										(n.attributes.refY = new A.Property(
											"refY",
											this.attribute("refY").value
										)),
										(n.attributes.width = new A.Property(
											"width",
											this.attribute("markerWidth").value
										)),
										(n.attributes.height = new A.Property(
											"height",
											this.attribute("markerHeight").value
										)),
										(n.attributes.fill = new A.Property(
											"fill",
											this.attribute(
												"fill"
											).valueOrDefault("black")
										)),
										(n.attributes.stroke = new A.Property(
											"stroke",
											this.attribute(
												"stroke"
											).valueOrDefault("none")
						...
						(A.Element.GradientBase = function(t) {
							...
							(this.getGradient = function() {}),
								...
								(this.inheritStopContainer = function(t) {
									for (
										var e = 0;
										e < this.attributesToInherit.length;
										e++
									) {
								...
								(this.createGradient = function(t, e, i) {
									...
									if (null == a)
										return s(
											n.stops[n.stops.length - 1].color
										);
									...
									if (
										...
										(l.attributes.x = new A.Property(
											"x",
											-A.MAX_VIRTUAL_PIXELS / 3
										)),
											(l.attributes.y = new A.Property(
												"y",
												-A.MAX_VIRTUAL_PIXELS / 3
											)),
											(l.attributes.width = new A.Property(
												"width",
												A.MAX_VIRTUAL_PIXELS
											)),
											(l.attributes.height = new A.Property(
												"height",
												A.MAX_VIRTUAL_PIXELS
											));
										var h = new A.Element.g();
										(h.attributes.transform = new A.Property(
											"transform",
											this.attribute(
												"gradientTransform"
											).value
										...
										(u.attributes.x = new A.Property(
											"x",
											0
										)),
											(u.attributes.y = new A.Property(
												"y",
												0
											)),
											(u.attributes.width = new A.Property(
												"width",
												o.width
											)),
											(u.attributes.height = new A.Property(
												"height",
												o.height
											)),
											(u.children = [h]);
						...
						(A.Element.AnimateBase = function(t) {
							(this.base = A.Element.ElementBase),
								...
								(this.getProperty = function() {
									var t = this.attribute("attributeType")
											.value,
										e = this.attribute("attributeName")
											.value;
									return "CSS" == t
						...
						(A.Element.animateTransform = function(t) {
							(this.base = A.Element.AnimateBase),
								...
								(this.calcValue = function() {
									for (
										var t = this.progress(),
											e = A.ToNumberArray(t.from.value),
											i = A.ToNumberArray(t.to.value),
											n = "",
											s = 0;
										s < e.length;
										s++
						...
						(A.Element.fontface = function(t) {
							(this.base = A.Element.ElementBase),
								...
								(this.descent = this.attribute(
									"descent"
								).value),
								(this.unitsPerEm = this.attribute(
									"units-per-em"
								).numValue());
						}),
						...
						(A.Element.glyph = function(t) {
							(this.base = A.Element.path),
								...
								(this.unicode = this.attribute(
									"unicode"
								).value),
								(this.arabicForm = this.attribute(
									"arabic-form"
								).value);
						}),
							...
							(this.captureTextNodes = !0),
								...
								(this.getBoundingBox = function() {
									...
									return new A.BoundingBox(
										...
										t +
											Math.floor(2 * i / 3) *
												this.children[0].getText()
													.length,
										e
									);
								}),
								(this.renderChildren = function(t) {
									(this.x = this.attribute("x").toPixels(
										"x"
									)),
										(this.y = this.attribute("y").toPixels(
											"y"
										)),
										this.attribute("dx").hasValue() &&
											(this.x += this.attribute(
												"dx"
											).toPixels("x")),
										this.attribute("dy").hasValue() &&
											(this.y += this.attribute(
												"dy"
											).toPixels("y")),
						...
						(A.Element.image = function(t) {
							...
							if ("" != e) {
								var a = e.match(/\.svg$/);
								if (
									(A.Images.push(this), (this.loaded = !1), a)
								)
								...
								(this.renderChildren = function(t) {
									...
									(this.getBoundingBox = function() {
										var t = this.attribute("x").toPixels(
												"x"
											),
											e = this.attribute("y").toPixels(
												"y"
											),
											i = this.attribute(
												"width"
						...
						(A.Element.g = function(t) {
							(this.base = A.Element.RenderedElementBase),
								...
								(this.getBoundingBox = function() {
									for (
										var t = new A.BoundingBox(), e = 0;
										e < this.children.length;
										e++
									)
										t.addBoundingBox(
											this.children[e].getBoundingBox()
										);
									return t;
								});
						}),
							...
							(this.path = function(t) {
								...
								(this.renderChildren = function(t) {
									if (null != n) {
										var e = n;
										"symbol" == n.type &&
											(((e = new A.Element.svg()).type =
												"svg"),
											(e.attributes.viewBox = new A.Property(
												"viewBox",
												n.attribute("viewBox").value
											)),
											(e.attributes.preserveAspectRatio = new A.Property(
												"preserveAspectRatio",
												n.attribute(
													"preserveAspectRatio"
												).value
											)),
											(e.attributes.overflow = new A.Property(
												"overflow",
							...
							(this.base = A.Element.ElementBase),
								...
								(this.apply = function(t, e) {
									var i = this.attribute("x").toPixels("x"),
										...
										s = this.attribute("width").toPixels(
											"x"
										),
										a = this.attribute("height").toPixels(
											"y"
										);
									if (0 == s && 0 == a) {
										for (
											var r = new A.BoundingBox(), o = 0;
									...
									e.render(f),
										(f.globalCompositeOperation =
											"destination-in"),
										(f.fillStyle = u.createPattern(
											h,
											"no-repeat"
										)),
										f.fillRect(0, 0, i + s, n + a),
										(t.fillStyle = f.createPattern(
											c,
											"no-repeat"
										)),
							...
							(this.base = A.Element.ElementBase),
								...
								(this.apply = function(t, e) {
									...
									for (
										...
										"function" ==
											typeof this.children[u].apply &&
											this.children[u].apply(
												m,
												0,
												0,
												a + 2 * l,
						...
						(A.Element.feColorMatrix = function(t) {
							(this.base = A.Element.ElementBase), this.base(t);
							var n = A.ToNumberArray(
								this.attribute("values").value
							);
							switch (this.attribute("type").valueOrDefault(
								"matrix"
							)) {
								case "saturate":
									var e = n[0];
							...
							var i = function(t) {
								for (var e = a.canvas; e; )
									(t.x -= e.offsetLeft),
										...
										(e = e.offsetParent);
								return (
									f.scrollX && (t.x += f.scrollX),
									f.scrollY && (t.y += f.scrollY),
									t
								);
							};
							...
							var l = !0,
								n = function() {
									...
									if (
										...
										null != A.opts.offsetX &&
											(o.attribute("x", !0).value =
												A.opts.offsetX),
										null != A.opts.offsetY &&
											(o.attribute("y", !0).value =
												A.opts.offsetY),
										...
										null != A.opts.scaleWidth &&
											...
											null == i && (i = n),
											null == n && (n = i),
											(o.attribute("width", !0).value =
												A.opts.scaleWidth),
											(o.attribute("height", !0).value =
												A.opts.scaleHeight),
											(o.style(
												"transform",
												!0,
									...
									1 != A.opts.ignoreClear &&
										a.clearRect(0, 0, t, e),
										o.render(a),
										l &&
											((l = !1),
											"function" ==
												typeof A.opts.renderCallback &&
												A.opts.renderCallback(r));
								},
								s = !0;
								...
								(w && !t.enableRedraw) ||
									(A.intervalID = setInterval(function() {
										...
										if (
											...
											for (
												var e = 0;
												e < A.Animations.length;
												e++
											)
												t |= A.Animations[e].update(
													1e3 / A.FRAMERATE
												);
										"function" ==
											typeof A.opts.forceRedraw &&
											1 == A.opts.forceRedraw() &&
											(t = !0),
											t && (n(), A.Mouse.runEvents());
									}, 1e3 / A.FRAMERATE));
						}),
						(A.stop = function() {
				...
				if (w) {
					...
					return (
						(m = i.ImageClass),
						(p = t.constructor),
						void n.loadXml(t.getContext("2d"), e)
					);
				}
				...
				void 0 !== e.documentElement
					? n.loadXmlDoc(s, e)
					: "<" == e.substr(0, 1) ? n.loadXml(s, e) : n.load(s, e);
			} else
				for (
					var a = document.querySelectorAll("svg"), r = 0;
					r < a.length;
					r++
				) {
					var o = a[r],
